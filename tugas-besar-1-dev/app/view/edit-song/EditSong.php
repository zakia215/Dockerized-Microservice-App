<?php
    ...
    $song_id = $_GET['id'];
    $song = $songService->getSongByID($song_id);
...
<body>
    ...
    <div class="container">
        ...
        <form id="add-song-form" class = "add-form">
            <div class="component-name">
                <input type="text" id="songTitle" class = "componentName" name="songTitle" placeholder="Song Title" value="<?php echo $title ?>">
            ...
            <div class="image-container" id="image-container-song">
                <img src="../../../upload/<?php
                    echo basename($cover_art);
                ?>" alt="sample-photo" class="cover_art" id="cover_art_song">
            ...
            <div class="dropdown-container">
                ...
                <select class= "dropdown-list" name="genre-song" id="genre-song">
                    ...
                    <option value="Dangdut"<?php if ($genre == "Dangdut") echo " selected"?>>Dangdut</option>
            ...
            <button type = "button" id = "delete-button" name = "delete-button">Delete Song</button>
        </form>
    </div>
    <script>
    ...
    <script src = "../../../../../public/javascript/edit_song.js"></script>
</body>
